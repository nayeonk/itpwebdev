Loops, charAt, substring, replace
=================================

Loops, data transformation using charAt and substring, and replace and regular expressions

******************************************************************
Please download the following zip file and extract it to a folder:

[Yuanbo](http://itpwebdev.herokuapp.com/starters/301/loops_charat_substring_replace.zip)

[Yuanbo Full Lecture Sample](http://itpwebdev.herokuapp.com/starters/301/loops_charat_substring_replace_end.zip)
